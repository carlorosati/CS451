...
public class ChessPieceQueen extends ChessPiece
{
	...
	public ChessPieceQueen(Color color, ImageIcon representation, int x, int y)
	{
		...
		if (color.equals(Color.BLACK)){
			image = new ImageIcon( getClass().getResource("/resources/ChessPieces/blackQueen.png") );
			this.representation = image;
		}else{
			image = new ImageIcon( getClass().getResource("/resources/ChessPieces/whiteQueen.png") );
			this.representation = image;
		}
	}
